...
def parse_description_lists(texer: TeXHandler) -> None:
    for p in texer.soup.find_all('p', attrs={'class': 'description-env'}):
        ...
        for br in p.find_all('br'):
            br.decompose()  # \\ and \hfill in LaTeX, which is often default HTML styling anyway
        ...
        for dd in p.find_all('dd'):
            ...
            while dd.next_sibling and (not isinstance(dd.next_sibling, bs4.Tag) or
                                       dd.next_sibling.name != 'dt'):
