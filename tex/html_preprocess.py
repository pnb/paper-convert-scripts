def fix_et_al(html_str: str) -> str:
    ...
    return (
        html_str.replace("\xa0almbox .<span class='accentb'>:</span>mbox ", " al.")
        .replace("\xa0almbox .<span class='accentb'>:</span>mbox", " al.")
        .replace(  # Replace a version that appears in footnote citations
            "\xa0almbox .</span><span class='accentb'><span class='ptmr7t-'>:"
            "</span></span><span class='ptmr7t-'>mbox </span><span class='ptmr7t-'>",
            " al.",
        )
    )
